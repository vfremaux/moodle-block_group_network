 ...
 */
    ...
    function get_content() {
		...
		if (has_capability('block/group_network:manageaccess', $context)){
		    ...
		    $this->content->items[] = "<a href=\"{$CFG->wwwroot}/blocks/group_network/single.php?courseid={$courseid}&amp;blockid={$this->instance->id}\">$singlewizard</a><br/>";
		    ...
		    if (!empty($groups)){
			    ...
			    $this->content->items[] = "<a href=\"{$CFG->wwwroot}/blocks/group_network/group.php?courseid={$courseid}&amp;blockid={$this->instance->id}\">$groupwizard</a><br/>";
			    $this->content->icons[] = $icon;
			}
